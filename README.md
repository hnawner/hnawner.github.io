# Personal Webste / Portfolio

This is the repository for my personal website. I'm not a web developer, so I used
a template from Start Bootstrap; the readme for the template is found below.
